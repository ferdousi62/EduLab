...
<div class="nav fixed-top nav_background shadow">
        ...
        <ul style="font-family: 'Oswald', sans-serif;letter-spacing: 1px;font-size: 1rem">
            ...
            <li><a href="adCourse_assignment.php" style="background:#9c27b0;">Assignments</a></li>
...
<!--Show all Assignment-->
             ...
             ?>
              ...
              <div class="show_assignment bg-alt">
                    <div class="first_line" style="display: -webkit-box;">
                        <div class="t_name" style=" width: 97%;"><?php echo $row['a_name']; ?></div>
                        <div class="option">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                                 <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
                                   ...
                                   <div class="dropdown-menu">
                                      ...
                                      <a href="admin_delete_assignment.php?a_id=<?php echo $row["a_id"]; ?>" class="dropdown-item">Delete</a>
                                    </div>
                             </div>
                         </div>
                     </div>
                     <?php 
            $duedate= $row['a_duedate'];
            ...
            else
            {
                echo "Something wrong<br>";
                     ...
                     <div class="info"><?php echo $row['a_info']; ?></div>
                     
                     <div style="display: inline-flex; width: -webkit-fill-available;">
            <div style="   padding-right: 9px; font-weight: 600;color: #000000d4;"> Upload time:  </div><?php echo $row['a_date']; ?>
            </div>
            <div style="display: inline-flex; width: -webkit-fill-available;">
            <div style="  padding-right: 9px;  font-weight: 600;color: #000000d4;"> Submission Deadline:  </div> <?php echo $row['a_duedate']; ?>
            </div>
