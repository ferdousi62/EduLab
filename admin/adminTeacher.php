...
<div class="nav fixed-top nav_background shadow">
       ...
       <div class="text1" style="    color: white; font-size: 26px;font-weight: 700;">EduLab</div>
        ...
        <ul style="font-family: 'Oswald', sans-serif;letter-spacing: 1px;font-size: 1rem; margin-bottom: 1px;margin-top: -4px;">
            <li> <a href="#teacherSignUp" role="button" class="btn " data-toggle="modal" style="background:#9c27b0;">Add Teacher</a></li>
        </ul>
...
<?php
  if($result->num_rows>0){
    while($row = $result->fetch_array()){
      ...
      $sql2=" SELECT * FROM `course` WHERE user_name='$username'";
...
?>
        ...
        <ul class="dropdown-menu " >
          <li><a type="button" class="details_btn dropdown-item" style="margin: auto; " data-toggle="modal" data-target="#details" 
                                      data-title="<?php echo $row['user_name']; ?>">details</a></li>
          <li><a href="admin_delete_teacher.php?user_name=<?php echo $row['user_name'];?>" class="dropdown-item">Delete</a></li>
       ...
       <li>
          <form method="post" action="adCourse_post.php">
           <div class="students" >
            ...
            <input type="hidden" name="course_name" value="<?php echo $row2['course_name']; ?>">
          
            <button type="submit" class="dropdown-item"> <div><?php echo $row2["course_name"];?></div></button>
         </form> 
       </li>
...
?>
                    ...
                    <div class="card-title " id="card-title" ><h5 id="search"><?php echo $row['user_name'];?></h5></div>
                    <p class="card-text" >Fullname: <?php echo $row['full_name'];?></p>
 ...
 <div class="bs-example">
    <div id="teacherSignUp" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            ...
            <form  onsubmit="return false;" action="adminTeacher.php" method="post">
    ...
    $("#details").on("show.bs.modal", function(event){
        ...
        $.ajax({
          ...
          //  $("#ass_date").val(inpValue);
                        ...
                        $('#bdate').text(value['Date_of_birth']);
                        $('#bplace').text(value['Birth_place']);
