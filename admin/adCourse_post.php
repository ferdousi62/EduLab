...
<div class="nav fixed-top nav_background shadow">
        ...
        <ul style="font-family: 'Oswald', sans-serif;letter-spacing: 1px;font-size: 1rem">
            <li><a href="adCourse_post.php" style="background:#9c27b0;">Post</a></li>
            ...
            <li><a href="adCourse_questionBank.php"> Question Bank </a></li>
...
<!--Start grid system-->
<?php
$sql="SELECT full_name FROM course WHERE c_code='$tc_code'";
$result=$conn->query($sql);
if($result->num_rows>0){
  while($row = $result->fetch_array()){
    $course_teacher= $row['full_name'];
    $_SESSION['course_teacher']= $course_teacher;
            ...
            <div class="col-md-10">
             ...
             <div class="col-md-12">
               <div class="title" style="font-family: 'Oswald', sans-serif;text-align: center; height: 112px;margin-bottom: 27px;">
                    ...
                    <div class="tchr_name" style="padding-left:7px;"><?php echo $course_teacher; ?></div>
                    </div>
                  </div>
              </div>
...
<?php
  ...
  $sql2= "SELECT * FROM post WHERE c_code='$tc_code' ORDER BY post_date DESC";
...
<?php while($row2 = $result2->fetch_array()){ ?>
                <div class="col-md-16" style="margin-bottom: 12px;">
                <div class="upload_partition bg-alt">

                    <div class="first_line" style="display: -webkit-box;">
                        <div class="t_name text1" style=" width: 97%;"><?php echo $row2['full_name'];?></div>
                        <div class="option">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                                 <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
                                   ...
                                   <div class="dropdown-menu">
                                      ...
                                      <a href="admin_delete_post.php?post_id=<?php echo $row2["post_id"]; ?>" class="dropdown-item">Delete</a>
                                    </div>
                           </div>
                        </div>
                    </div>
                    ...
                    <div class='post_date'><?php echo $row2['post_date'];?></div>
                    <div class='t_post'><?php echo $row2['post'];?></div>
