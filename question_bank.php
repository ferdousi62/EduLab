...
<div class="list-group"  style="  font-family: 'Oswald', sans-serif;text-align: center;"> 
    <a href="class.php"  class="list-group-item list-group-item-action " >Post</a>
    <a href="classMaterial.php" class="list-group-item list-group-item-action">Class Materials</a>
    <a href="takeQuiz.php" class="list-group-item list-group-item-action ">Take Quiz </a>
    <a href="assignment.php" class="list-group-item list-group-item-action "> Take Assignment </a>
    <a href="question_bank.php" class="list-group-item list-group-item-action"style="background:#2196f3;">Question Bank</a>
    <a href="student_list.php" class="list-group-item list-group-item-action "> Students </a>
</div>
...
<!--Show all Assignment-->
  ...
  <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
    ...
    <div class="dropdown-item"><a href="question_bank/<?php echo $row['question_file']?>"target="_blank" >Download</a></div>
    <div class="dropdown-item">   <a href="question_bank_delete.php?question_id=<?php echo $row["question_id"]; ?>">Delete</a></div>
...
?>
            ...
            <a href="#upload_que"   data-toggle="modal" style="    font-family: 'Roboto Condensed', sans-serif;
    font-weight: 700;">
...
<div class="bs-example">
    ...
    <div id="upload_que" class="modal fade" tabindex="-1">
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
...
<form id="form" action="question_bank.php" method="post" enctype="multipart/form-data">
    <input type="hidden" class="custom-post-input" name="c_code" id="c_code" value="<?php echo $tc_code;?>">
     <div class="form-group">
    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="upload_question">
  
     </div>
 
    </div>
      
    <div id="up_que_alert"class="alert alert-danger alert-dismissible fade show" style=" margin-top: 11px;visibility: hidden;display: contents;">
                   <strong><div class="up_que_alert"style=" font-family: 'FontAwesome';"></div></strong>
                </div>

    <div class="modal-footer" style="margin-top: 16px; font-family: 'Oswald';margin-left: 55%;">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mr-auto upload_que_btn" name="upload_que_btn">Upload</button>
                </div>
...
<script>
     $('.upload_que_btn').click(function (e) { 
        e.preventDefault();
        var form=document.getElementById('form');
        var fdata=new FormData(form); 
        $.ajax({
            type: "POST",
            url: 'upload_que_process.php',
            data: fdata,
            contentType: false,
            cache: false,
            processData:false,
            ...
            { 
                document.getElementById("up_que_alert").style.visibility = "visible";
        document.getElementById("up_que_alert").style.display = "flex";
        $('.up_que_alert').html(result);
            }
        });
    });
</script>
