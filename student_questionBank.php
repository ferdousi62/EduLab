...
<div class="list-group"  action = "<?php $_PHP_SELF ?>" method = "GET" style="  font-family: 'Oswald', sans-serif;text-align: center;"> 
    ...
    <a href="student_questionBank.php" class="list-group-item list-group-item-action active"style="background:#2196f3;"> Question Bank </a>
...
<!--Show all Assignment-->
            ...
            <?php
             $sql= "SELECT * FROM question_bank WHERE c_code='$sc_code' ORDER BY question_date DESC";
...
<div class="bs-example">
    ...
    <div id="joinCourse" class="modal fade" tabindex="-1">
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
            ...
            <input type="text" class="form-control" id="courseCode" name="c_code" placeholder="Enter Course Code" required>
        </div>
        <div id="joinclass_alert_show"class="alert alert-danger alert-dismissible fade show" style="visibility:hidden; display: contents;">
                   <strong> <div class="joinclass_alert_show"style="font-family: 'FontAwesome';"></div></strong>
                </div>
...
<form id="form" action="question_bank.php" method="post" enctype="multipart/form-data">
    <input type="hidden" class="custom-post-input" name="c_code" id="c_code" value="<?php echo $sc_code;?>">
     <div class="form-group">
...
<script>
     $('.upload_que_btn').click(function (e) { 
        ...
        $.ajax({
            type: "POST",
            url: 'upload_studentque_process.php',
            data: fdata,
            contentType: false,
            cache: false,
            processData:false,
